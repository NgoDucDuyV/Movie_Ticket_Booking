...
const ClientNotFound = () => {
    return (
        <>
            <Container className='bg-background-light dark:bg-background-dark'>
                {/* Large Background Numbers */}
                <div className="absolute bottom-40 left-1/2 -translate-x-1/2 flex pointer-events-none">
                    <span className="text-[25rem] text-white/20 font-black leading-none tracking-tighter">
                        404
                    </span>
                </div>
                ...
                <div className="w-full text-center z-10 mb-10">
                    ...
                    <div className="mb-10 relative flex justify-center">
                        <div className="w-64 h-64 md:w-80 md:h-80 relative flex items-center justify-center">
                            ...
                            <div className="relative w-full h-full bg-center bg-no-repeat bg-contain" data-alt="A single empty red theater seat under a dim spotlight">
